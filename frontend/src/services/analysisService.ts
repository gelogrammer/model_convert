...
export const createCompleteAnalysis = async (
  ...
  try {
    ...
    const dominantEmotion = formatEmotionName(primaryEmotion);
    ...
    console.error('Error creating complete analysis:', error);
    throw new Error('Failed to create complete analysis');
  }
}; 